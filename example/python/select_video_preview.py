...
def process_frame(depth_buf: np.ndarray, amplitude_buf: np.ndarray, max_distance: int) -> np.ndarray:
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if frame != None:
            ...
            result_image = process_frame(depth_buf,amplitude_buf,max_distance)
